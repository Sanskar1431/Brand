                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-bg-surface border border-border-subtle focus:border-accent p-3 outline-none text-sm text-text-primary transition-colors uppercase font-mono focus:ring-1 focus:ring-accent/30 focus:shadow-[0_0_12px_rgba(212,163,89,0.15)]"
                    />
                  </div>
                </div>
                ...
                <div className="border-t border-border-subtle/30 pt-4 space-y-2 relative">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-bg-primary border border-border-subtle p-2 text-[10px] tracking-wider outline-none focus:border-accent text-text-primary uppercase font-mono focus:ring-1 focus:ring-accent/30 focus:shadow-[0_0_12px_rgba(212,163,89,0.15)]"
                    />
                    <button
                      type="button"
                      onClick={applyPromo}
                      className="bg-bg-primary border border-border-subtle hover:border-accent text-chrome hover:text-accent px-4 py-2 text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer outline-none focus:ring-1 focus:ring-accent focus:shadow-[0_0_12px_rgba(212,163,89,0.15)]"
                    >
                      APPLY
                    </button>
                  </div>
